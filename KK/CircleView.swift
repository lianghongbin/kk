...
class CircleView: UIView, UIScrollViewDelegate {
    ...
    private func setUpCircleView() {
        ...
        var width:CGFloat = 20*CGFloat(imageArray.count);
        ...
        pageIndicator.tintColor = UIColor.lightGrayColor()
        pageIndicator.pageIndicatorTintColor = UIColor.whiteColor()
        pageIndicator.currentPageIndicatorTintColor = UIColor.blueColor()
        pageIndicator.backgroundColor = UIColor(red: 0.667, green: 0.667, blue: 0.667, alpha: 0.4)
